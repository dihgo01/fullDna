        ...
        <div class="page-body-wrapper">
            ...
            <div class="page-body">
                ...
                <?php } elseif ($page_start === 'cadastro' || $page_start === 'edicao') { ?>
                    ...
                    <!-- Container-fluid starts-->
                    <div class="container-fluid">
                        <form id="form-empresas" class="theme-form needs-validation" novalidate="" action="<?php echo WEBURL ?>php/modulos/empresas-grupo/code/ajax-empresas-grupo.php?action_type=cadastro_de_empresas&type=<?php echo ($page_start === 'cadastro' ? 'new' : 'edit') ?>&key=<?php echo ($page_start === 'cadastro' ? '' : $current_row->hash) ?>" method="POST">
                            <div class="col-sm-12" id="empresas-grupos">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <label class="col-form-label" for="logo">Imagem de Capa da Proposta Comercial</label>
                                                <input class="form-control mb-3" type="file" name="capa_proposta_comercial" <?php
                                                                                                            if ($page_start === 'cadastro') {
                                                                                                                echo 'required';
                                                                                                            }
                                                                                                            ?>>
                                                <p class="text-muted fs-12">Faça o upload da imagem que deseja incluir na capa da proposta comercial, de no máximo 1MB</p>
                                                <?php if ($page_start === 'edicao') { ?>
                                                    <a class="logo_view" href="#"><i class="icon-image"></i> Clique aqui para ver a logo atual</a>
                                                <?php } ?>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label class="col-form-label" for="logo">Cabeçalho da Proposta Comercial</label>
                                                <input id="icone-input" class="form-control mb-3" type="file" name="cabecalho_proposta_comercial" <?php
                                                                                                                                    if ($page_start === 'cadastro') {
                                                                                                                                        echo 'required';
                                                                                                                                    }
                                                                                                                                    ?>>
                                                <p class="text-muted fs-12">Faça o upload da imagem de cabeçalho da proposta comercial, de no máximo 1MB</p>
                                                <?php if ($page_start === 'edicao') { ?>
                                                    <a class="icone_view" href="#"><i class="icon-image"></i> Clique aqui para ver a ícone atual</a>
                                                <?php } ?>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label class="col-form-label" for="logo">Rodapé da Proposta Comercial</label>
                                                <input id="icone-input" class="form-control mb-3" type="file" name="rodape_proposta_comercial" <?php
                                                                                                                                    if ($page_start === 'cadastro') {
                                                                                                                                        echo 'required';
                                                                                                                                    }
                                                                                                                                    ?>>
                                                <p class="text-muted fs-12">Faça o upload da imagem do rodapé da proposta comercial, de no máximo 1MB</p>
                                                <?php if ($page_start === 'edicao') { ?>
                                                    <a class="icone_view" href="#"><i class="icon-image"></i> Clique aqui para ver a ícone atual</a>
                                                <?php } ?>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label class="col-form-label" for="logo">Imagem de Fundo da Proposta Comercial</label>
                                                <input id="icone-input" class="form-control mb-3" type="file" name="imagem_de_fundo_proposta_comercial" <?php
                                                                                                                                    if ($page_start === 'cadastro') {
                                                                                                                                        echo 'required';
                                                                                                                                    }
                                                                                                                                    ?>>
                                                <p class="text-muted fs-12">Faça o upload de uma imagem de fundo da proposta comercial, de no máximo 1MB</p>
                                                <?php if ($page_start === 'edicao') { ?>
                                                    <a class="icone_view" href="#"><i class="icon-image"></i> Clique aqui para ver a ícone atual</a>
                                                <?php } ?>
                                            </div>
